...
def retrieve(
    ...
    """
    # Step 1: Chạy semantic + lexical retrieval
    try:
    ...
    if use_reranking and merged:
        try:
            ...
            print(f"Lỗi Reranking: {e}. Sử dụng kết quả merge ban đầu.")
    ...
    if not final_results or best_score < score_threshold:
        ...
        try:
            ...
            print(f"Lỗi khi thực hiện PageIndex search: {e}")
            return final_results[:top_k]

    # Đảm bảo tất cả kết quả có source được định danh đúng
